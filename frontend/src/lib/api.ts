...
const API_BASE_URL = import.meta.env.PROD ? "https://metron-production.up.railway.app" : undefined;

// Dev uses relative paths through Vite; prod bypasses the frontend /api proxy.
